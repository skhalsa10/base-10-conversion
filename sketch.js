...
function setup() {
  ...
  base10Input.parent(base10InputDiv);
  base10InputDiv.addClass("input-form");
  base10Input.id("base-10-input");
  newBaseInputDiv = createDiv();
  newBaseInputDiv.addClass("input-form");
